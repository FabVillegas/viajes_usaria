...
module.exports = function( grunt ) {
	/**
	*	Mide el tiempo que las tareas de Grunt toman.
	*/
    require( 'time-grunt' )( grunt );
	/**
	*	Configuracion de cada tarea
	*/
	grunt.initConfig({
		pkg: grunt.file.readJSON( 'package.json' ),
		/**
		* Clean: Elimina archivos
		*/
		clean: {
			dist: {
				files: [{
		...
		*/
		...
		/**
		*	Copy: Copia archivos de una fuente y los lleva a una carpeta destino
		*/
		copy: {
			main: {
				files: [
		...
		/**
		*	imagemin: Minifica archivos de tipo imagenes
		*/
		imagemin: {
			dist: {
				files: [{
		...
		/**
		*	svgmin: Minifica archivos de tipo svg
		*/
		svgmin: {
			dist: {
				files: [{
...
//		},
		...
		*/
		...
		/**
		*	ngdocs
		*	Documentacion de codigo de angularjs
		*/
		ngdocs: {
			all: [ 'app/states/inicio/**.js' ],
			options: {
				dest: 'docs',
				html5Mode: false,
